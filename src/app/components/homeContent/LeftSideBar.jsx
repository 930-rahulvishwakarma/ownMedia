...
const LeftSideBar = () => {
  ...
  return loading || !isLoaded ? (
    ...
    <div className="h-screen left-0 top-0 sticky bg-[#18152075] overflow-auto px-10 py-6 flex flex-col gap-6 max-md:hidden 2xl:w-[350px] pr-20 custom-scrollbar sm:hidden">
      <Link href="/">
